...
# saving the model 
classifier.save('/Users/saeedeh/Desktop/Alphabet pics/Alphabets/AlphabetResults/Alphabet_bz='+ str(bz)+'_e='+str(e)+'_spe='+str(spe)+ '_vs='+str(vs)+'.h5')
input("Press Enter to continue...")

file1 = open('/Users/saeedeh/Desktop/Alphabet pics/Alphabets/AlphabetResults/Alphabet_bz='+ str(bz)+'_e='+str(e)+'_spe='+str(spe)+ '_vs='+str(vs)+'.txt',"w") 
...
plt.savefig('/Users/saeedeh/Desktop/Alphabet pics/Alphabets/AlphabetResults/Alphabet_bz='+ str(bz)+'_e='+str(e)+'_spe='+str(spe)+ '_vs='+str(vs)+'.png')
