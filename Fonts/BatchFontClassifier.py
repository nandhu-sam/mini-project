...
def ClassifyFont(neurons, letter, bz, e, spe, vs):
    ...
    # saving the model 
    classifier.save('/Users/saeedeh/Desktop/Alphabet pics/Fonts/' + letter + '/Results/' + letter + '_ne=' + str(
        neurons) + '_bz=' + str(bz) + '_e=' + str(e) + '_spe=' + str(spe) + '_vs=' + str(vs) + '.h5')

    # Making predictions

    # input("Press Enter to continue...")

    file1 = open('/Users/saeedeh/Desktop/Alphabet pics/Fonts/' + letter + '/Results/' + letter + '_ne=' + str(
        neurons) + '_bz=' + str(bz) + '_e=' + str(e) + '_spe=' + str(spe) + '_vs=' + str(vs) + '.txt', "w")
    ...
    plt.savefig('/Users/saeedeh/Desktop/Alphabet pics/Fonts/' + letter + '/Results/' + letter + '_ne=' + str(
        neurons) + '_bz=' + str(bz) + '_e=' + str(e) + '_spe=' + str(spe) + '_vs=' + str(vs) + '.png')
